...
const Duration _kUnconfirmedRippleDuration =
    Duration(milliseconds: 75); //控制水波纹出现时长
...
/// is used when the [Theme]'s [ThemeData.splashFactory] is [EdenInkFactory.splashFactory].
///
/// See also:
///
...
///    [Material].
class EdenInkFactory extends InteractiveInkFeature {
